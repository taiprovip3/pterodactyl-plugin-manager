    ...
    protected static array $permissions = [
        ...
        'database' => [
            ...
            'keys' => [
                ...
                'update' => 'Allows a user to modify the database associated with this server.',
                'delete' => 'Allows a user to delete the database associated with this server.',
                'view_password' => 'Allows a user to view the database password in plaintext.',
            ],
        ],

        'schedule' => [
            'description' => 'Permissions that control a user\'s ability to view and manage the server\'s schedules.',
            'keys' => [
                'read' => 'Allows a user to view scheduled tasks for the server.',
                'create' => 'Allows a user to create new scheduled tasks for the server.',
                'update' => 'Allows a user to edit existing scheduled tasks.',
                'delete' => 'Allows a user to delete scheduled tasks for the server.',
            ],
        ],

        'settings' => [
            'description' => 'Permissions that control a user\'s ability to change server settings.',
            'keys' => [
                'rename' => 'Allows a user to rename the server.',
                'reinstall' => 'Allows a user to reinstall the server or its configuration.',
            ],
        ],

        'activity' => [
            'description' => 'Permissions that control a user\'s ability to view the activity log for the server.',
            'keys' => [
                'read' => 'Allows a user to view the server activity log.',
            ],
        ],
    ];

    /**
     * Get the list of permissions available on the system.
     *
